...
public class Simulation extends BaseCloudSimObservable implements Constants {
	...
	private String loadBalancePolicy = Constants.LOAD_BALANCE_ANT_COLONY;
	...
	public void runSimulation() throws Exception {
		...
		System.out.println("Number of Datacenters: " + dataCenters.size());
		System.out.println("Number of User Bases: " + userBases.size());
		...
		//Initialize GridSim
		System.out.println("Initializing GridSim...");
		...
		System.out.println("Creating datacenters...");
		for (DataCenterUIElement d : dataCenters) {
			if (d.isAllocated()){
				System.out.println("  - Creating DC: " + d.getName());
		...
		System.out.println("Starting GridSim...");
		GridSim.startGridSimulation();
		System.out.println("GridSim completed!");
